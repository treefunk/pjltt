...
<section id="home-banner">
  ...
  <div class="content">
    <div class="container"  data-wow-duration="1s"> <span class="wow fadeIn">Your reliable travel companion.</span>
      ...
      <br></br>
     <a href="<?php echo e(url('offerpage')); ?>" class="btn">Book Now</a>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row"> 
      ...
      <div class="section-title text-center wow fadeInUp">
        <h2>About us</h2>
        <a href="<?php echo e(url('about')); ?>">Read More</a>
  ...
  <div class="container">
    <div class="row wow fadeInUp">
      <p>If you have questions or suggestions about the services of PJL Travel and Tours, please read through our FAQs or directly contact us if the answer to your question is not listed.</p>
       <a href="<?php echo e(url('contact')); ?>">Contact</a> </div>
  </div>
</section>
...
<section id="our-work-block">
  <div class="container">
    <div class="row"> 
      ...
      <div class="section-title text-center wow fadeInUp">
        <h2>Offers</h2>
         <a href="<?php echo e(url('offerpage')); ?>">more offers</a></div>
      <!--/section-title-->
      <div class="clearfix"></div>
      <div class="works">
        <ul class="grid">
              ...
              <figcaption>
                <div class="caption-content  wow fdeInUp">
                 <h6>Boracay Tour</h6>
                  ...
                  <br>
                  <a href="<?php echo e(url('booknow')); ?>/1"><button type="button">Book Now!</button></a>
                  <!--ul class="work-more">
            ...
            <figure> <img src="img/samal.jpg" alt="Screenshot 01">
              <figcaption>
                <div class="caption-content">
                  ...
                  <br>
                  <a href="<?php echo e(url('booknow')); ?>/2"><button type="button">Book Now!</button></a>
                  <!--ul class="work-more">
                    <li><a href="#"><i class="fa fa-search"></i></a></li>
                    <li><a href="#"><i class="fa fa-link"></i></a></li>
                  </ul-->
            ...
            <figure> <img src="img/underground.jpg" alt="Screenshot 01">
              <figcaption>
                <div class="caption-content">
                  ...
                  <br>
                  <a href="<?php echo e(url('booknow')); ?>/3"><button type="button">Book Now!</button></a>
                  <!--ul class="work-more">
                    <li><a href="#"><i class="fa fa-search"></i></a></li>
                    <li><a href="#"><i class="fa fa-link"></i></a></li>
                  </ul-->
            ...
            <figure> <img src="img/cambodia.jpg" alt="Screenshot 01">
              <figcaption>
                <div class="caption-content">
                  ...
                  <br>
                  <a href="<?php echo e(url('booknow')); ?>/4"><button type="button">Book Now!</button></a>
                  <!--ul class="work-more">
                    <li><a href="#"><i class="fa fa-search"></i></a></li>
                    <li><a href="#"><i class="fa fa-link"></i></a></li>
                  </ul-->
            ...
            <figure> <img src="img/bangkok.jpg" alt="Screenshot 01">
              <figcaption>
                <div class="caption-content">
                  ...
                  <br>
                  <a href="<?php echo e(url('booknow')); ?>/5"><button type="button">Book Now!</button></a>
                  <!--ul class="work-more">
                    <li><a href="#"><i class="fa fa-search"></i></a></li>
                    <li><a href="#"><i class="fa fa-link"></i></a></li>
                  </ul-->
            ...
            <figure> <img src="img/hongkong.jpg" alt="Screenshot 01">
              <figcaption>
                <div class="caption-content">
                  ...
                  <center><h6>₱10,000&nbsp;per person&nbsp;/&nbsp;3 Days, 2 Nights</h6></center>
                  <br>
                  <a href="<?php echo e(url('booknow')); ?>/6"><button type="button">Book Now!</button></a>
                  <!--ul class="work-more">
                    <li><a href="#"><i class="fa fa-search"></i></a></li>
                    <li><a href="#"><i class="fa fa-link"></i></a></li>
                  </ul-->
