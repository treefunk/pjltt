...
<b style="margin-left:100px;" >BOOKING ID: <?php echo e($book->id); ?></b><br><br>
<b style="margin-left:100px;">Booking Date: <?php echo e(date("Y-m-d H:i" ,strtotime($book->enddate)-86400)); ?></b><br><br>
<b style="margin-left:100px;">Total Amount (PHP): <?php echo e(($book->guest * $book->package->tour->price)); ?></b><br><br>
<hr style="margin-left:100px; margin-right:100px;" ><br>
<b style="margin-left:100px;">Customer's First Name:  <?php echo e($book->user->name); ?></b><br><br>
<b style="margin-left:100px;">Customer's Last Name:  <?php echo e($book->user->lname); ?></b><br><br>
<b style="margin-left:100px;">Customer's E-mail Address:  <?php echo e($book->user->email); ?></b><br><br>
<b style="margin-left:100px;">Rooms and Guests Availed: <?php echo e($book->guest); ?> </b><br><br>
<b style="margin-left:100px;">Departure Date: <?php echo e($book->departuredate); ?></b><br><br>
