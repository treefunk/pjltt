        ...
        <h1>Any questions?</h1>
            <form style="padding-bottom:80px" method="POST" action="/contact">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputName" placeholder="Name" name="name" value="<?php echo e(old('name')); ?>">
                    <?php echo e($errors->first('name')); ?>

                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Email address</label>
                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Email" name="email" value="<?php echo e(old('email')); ?>">
                    <?php echo e($errors->first('email')); ?>

                </div>
                <div class="form-group">
                    <label for="exampleInputMessage">Message</label>
                    <textarea placeholder="Add your message" name="message" value="<?php echo e(old('message')); ?>"></textarea>
